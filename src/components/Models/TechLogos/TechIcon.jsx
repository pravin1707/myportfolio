// Might not need this section later since the displaying the techstack
// icons in 3D is a little bit over the top hence usage of clear high 
// quality 2D icons should be fine
